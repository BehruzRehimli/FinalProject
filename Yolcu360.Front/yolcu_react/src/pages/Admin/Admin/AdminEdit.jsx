...
const AdminEdit = () => {
    ...
    useEffect(() => {
        const getCountry = async () => {
            ...
            try {
                var data = await axios.get(`https://localhost:7079/api/Admins/${id}`, { headers: { "Authorization": headerToker } })
                    ...
                    loader ?
                        <Formik>
                            <Formik enableReinitialize initialValues={{
                                ...
                                try {
                                    var result = await axios.put(`https://localhost:7079/api/Admins/${id}`, values, { headers: { "Authorization": headerToken } })
