...
const OfficeEdit = () => {
    ...
    const BtnHandler = async (e) => {
        ...
        try {
            var data = await axios.put(`https://localhost:7079/api/offices/${id}`, postValues, {
                headers: {
    ...
    useEffect(() => {
        ...
        const getCountry = async () => {
            ...
            try {
                var data = await axios.get(`https://localhost:7079/api/Offices/${id}`, { headers: { "Authorization": headerToker } })
