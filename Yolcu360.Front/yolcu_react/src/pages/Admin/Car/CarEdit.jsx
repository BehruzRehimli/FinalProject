...
const CarEdit = () => {
    ...
    const BtnHandler = async (e) => {
        ...
        try {
            var data = await axios.put(`https://localhost:7079/api/cars/${id}`, postValues, {
                headers: {
    ...
    useEffect(() => {
        const getCountries = async () => {
            var headerToken = `Bearer ${adminToken}`
            try {
                var datas = await axios.get("https://localhost:7079/api/Offices", { headers: { "Authorization": headerToken } })
                var models = await axios.get("https://localhost:7079/api/Models", { headers: { "Authorization": headerToken } })
                var types = await axios.get("https://localhost:7079/api/Types", { headers: { "Authorization": headerToken } })
        ...
        const getCar = async () => {
            ...
            try {
                var data = await axios.get(`https://localhost:7079/api/Cars/${id}`, { headers: { "Authorization": headerToker } })
