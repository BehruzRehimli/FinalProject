      ...
      <div>
        ...
        <Formik>
          <Formik initialValues={{
            ...
            axios.post("https://localhost:7079/api/Accounts/ResetPassword", values).then(res =>toast.success("Your password has been updated"), navigator("/")).catch(err => navigator("/error"))
          }}>
            {({ values }) => (
              <Form>
